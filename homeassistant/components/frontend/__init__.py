...
async def async_setup(hass, config):
    ...
    hass.components.websocket_api.async_register_command(
        WS_TYPE_GET_THEMES, websocket_handle_get_themes, SCHEMA_GET_THEMES)
    hass.components.websocket_api.async_register_command(
        WS_TYPE_GET_TRANSLATIONS, websocket_handle_get_translations,
...
@callback
def websocket_handle_get_themes(hass, connection, msg):
...
@callback
def websocket_handle_get_translations(hass, connection, msg):
